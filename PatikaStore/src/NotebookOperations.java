...
public class NotebookOperations extends Notebooks {

    private static TreeSet<Notebooks> modelSet = new TreeSet<>(new NotebookIDComp());
    private static TreeSet<Notebooks> modelSetByBrands = new TreeSet<>(new NotebookBrandComp());

    public NotebookOperations(int id, double price, int discountRate, int stock, String name, int memory, double screenSize, int ram, Brand brand) {
